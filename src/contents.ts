...
export const workPosts = [
  {
    ...
    description:
      "Eine Helfer-Applikation, um PDF-Templates für eine private Anwendung zur Ressourcenplanung herzustellen.",
    meta: [
      {
        key: "Features",
        value:
          "Templates mittels HTML, CSS und JS. Freie Verknüpfung mit externen Datenquellen. Vertikale und horizontale Voransicht mit automatischem Seitenumbruch. Optionale, automatisch generierte Schweizer QR-Rechnung mit optionaler Daten-Validierung und -Formatierung. Ansichtsgetreuer Ausdruck über den Browser.",
      },
    ...
    meta: [
      {
        key: "Features",
        value:
          "Servicepositionen und -gruppen. Multiple Serviceanbieter (Mitarbeiter). Arbeitspläne. Automatische Terminbelegung und E-Mail-Benachrichtigungen.",
      },
  ...
  },
  {
    ...
    description:
      "Komplettes Setup und Frontend einer privaten Hobbyradiostation. Selbstgehostetes Backend auf einem gebrauchten ThinkCentre M900 Tiny. Schutz und Frontend über Cloudflare.",
    meta: [
  ...
  },
  {
    title: "Customer Map",
    description:
      "Geschlossene Web-Applikation, um bestimmte Arbeitsschritte bei der Kundengewinnung zu erleichtern.",
    meta: [
      {
        key: "Features",
        value:
          "Selektive Anzeige von Kundengruppen. Selektive Suche nach Neukunden mittels einstellbarer Schlüsselwörter und Ortschaft. Suchfunktion für Ortschaften und automatische Anzeige aktueller Kennzahlen des Gemeindeportraits. Shortcuts für Telefon, Website und Reiseroute. Ablagefunktion für neue Adressen. Einstellbares Karten-Theme. Dark- und Light-UI.",
      },
